...
def init_historical_data():
    ...
    intervals = {'15m': Client.KLINE_INTERVAL_15MINUTE, '30m': Client.KLINE_INTERVAL_30MINUTE, '3d': Client.KLINE_INTERVAL_3DAY}
...
def start_websockets():
    ...
    ws_manager.start_kline_futures_socket(callback=lambda m: process_ws_kline(m, '3d'), symbol=SYMBOL, interval=Client.KLINE_INTERVAL_3DAY)
    ...
    while True:
        try:
            ...
            if current_pos != "NONE":
                ...
                b_3d = (inds['3d']['macd'] > inds['3d']['macd_prev']) and (inds['3d']['macd'] >= 0 or inds['3d']['k'] > inds['3d']['d'])
                b_30m = (inds['30m']['macd'] > inds['30m']['macd_prev']) and (inds['30m']['macd'] >= 0 or inds['30m']['k'] > inds['30m']['d'])
                s_3d = (inds['3d']['macd'] < inds['3d']['macd_prev']) and (inds['3d']['macd'] <= 0 or inds['3d']['k'] < inds['3d']['d'])
                s_30m = (inds['30m']['macd'] < inds['30m']['macd_prev']) and (inds['30m']['macd'] <= 0 or inds['30m']['k'] < inds['30m']['d'])

                if is_long and not (b_3d and b_30m):
                ...
                elif is_short and not (s_3d and s_30m):
                ...
                c_buy_3d = (inds['3d']['macd'] > inds['3d']['macd_prev']) and (inds['3d']['macd'] >= 0 or inds['3d']['k'] > inds['3d']['d'])
                ...
                c_sell_3d = (inds['3d']['macd'] < inds['3d']['macd_prev']) and (inds['3d']['macd'] <= 0 or inds['3d']['k'] < inds['3d']['d'])
                ...
                if c_buy_3d and c_buy_30m and c_buy_15m:
                    execute_trade("LONG", current_price, "ĐỒNG THUẬN TĂNG", inds)
                elif c_sell_3d and c_sell_30m and c_sell_15m:
