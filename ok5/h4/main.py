...
def init_historical_data():
    ...
    intervals = {'1h': Client.KLINE_INTERVAL_1HOUR, '4h': Client.KLINE_INTERVAL_4HOUR, '1w': Client.KLINE_INTERVAL_1WEEK}
    ...
    while True:
        try:
            ...
            if current_pos != "NONE":
                ...
                s_4h = (inds['4h']['macd'] < inds['4h']['macd_prev']) and (inds['4h']['macd'] <= 0 or inds['4h']['k'] < inds['4h']['d'])

                if is_long and not (b_1w and b_4h):
                ...
                elif is_short and not (s_1w and s_4h):
                ...
                # CẬP NHẬT LOGIC 1H SỬ DỤNG NẾN T0 VÀ T-1 (Theo yêu cầu giữ nguyên trước đó)
                ...
                if c_buy_1w and c_buy_4h and c_buy_1h:
                    execute_trade("LONG", current_price, "ĐỒNG THUẬN TĂNG", inds)
                elif c_sell_1w and c_sell_4h and c_sell_1h:
